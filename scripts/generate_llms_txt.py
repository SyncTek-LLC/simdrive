...
Then in Claude: _"Run a smoke test on the Example Reader app and record it as Example Reader-smoke."_ Claude drives the simulator, records every action as a deterministic YAML file. Future CI runs replay that YAML without calling Claude.
