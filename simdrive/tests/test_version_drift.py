...
class TestDiskVersionReadsSimdrivePackage:
    ...
    def test_call_tool_injects_warning_in_Example Reader_dogfood_environment(self) -> None:
        ...
        def Example Reader_env_metadata_version(package_name: str) -> str:
            if package_name == "specterqa-ios":
        ...
        with patch("importlib.metadata.version", side_effect=Example Reader_env_metadata_version):
            server._DISK_VERSION_CACHE["checked_at"] = 0.0
            server._DISK_VERSION_CACHE["version"] = None
