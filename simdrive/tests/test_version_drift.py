...
class TestDiskVersionReadsSimdrivePackage:
    ...
    def test_disk_version_old_wheel_causes_false_positive_warning(self) -> None:
        """Simulate the Palace dogfood environment where specterqa-ios 16.0.0a3
        ...
        # Simulate the Palace environment: specterqa-ios 16.0.0a3 is installed
    ...
    def test_check_version_drift_no_false_positive_in_old_wheel_env(self) -> None:
        """In the Palace dogfood environment (specterqa-ios 16.0.0a3 installed),
    ...
    def test_call_tool_injects_warning_in_palace_dogfood_environment(self) -> None:
        """In the Palace dogfood environment (specterqa-ios 16.0.0a3 still installed),
        ...
        # Simulate Palace dogfood: specterqa-ios 16.0.0a3 installed, simdrive 1.0.0a2 installed
        def palace_env_metadata_version(package_name: str) -> str:
            if package_name == "specterqa-ios":
        ...
        with patch("importlib.metadata.version", side_effect=palace_env_metadata_version):
            server._DISK_VERSION_CACHE["checked_at"] = 0.0
            server._DISK_VERSION_CACHE["version"] = None
        ...
        assert "_simdrive_warning" not in result, (
            f"call_tool() injected a false-positive _simdrive_warning in the Palace "
