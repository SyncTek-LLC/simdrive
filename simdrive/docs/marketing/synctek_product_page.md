...
- [Case study: Example Reader iOS migrated off the predecessor in 5 days](/blog/case-study-Example Reader) — the reader + OAuth coverage that XCTest couldn't reach
