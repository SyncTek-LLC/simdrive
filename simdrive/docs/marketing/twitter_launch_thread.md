...
Receipt: ThePalaceProject's Palace iOS app — public-library reading client, Readium WKWebView + OAuth/SAML — migrated off the predecessor in 5 days. Three dogfood rounds, all feedback closed.
