...
2. The *dogfood velocity loop* — Palace receipts, three feedback rounds closed in five days, moving-target release cadence (5 versions in 1 week).
...
| 11 | Palace dogfood receipts + "canonical iOS sim driver" testimonial | **Crown jewel** | `SIMDRIVE_v0.2.0a1_DOGFOOD.md` (Palace repo), CHANGELOG | A clone *cannot* have these. Permanent reputational asset. Most under-rated IP we own. |
...
4. **Brand + dogfood receipts.** Palace's testimonial belongs to *us*, not to a fork.
...
- **Document first-use-in-commerce.** Save dated PDFs of: PyPI page, README hero, repo description, Palace dogfood report.
...
| **Brand + dogfood receipts** | Low (already accumulating) | **High.** Palace migration is permanent reputational asset; clones can't have it. |
...
| 6 | **Capture first-use evidence** — dated PDFs/PNGs of PyPI page, README hero, repo description, Palace dogfood report. | #6 | $0 | Atlas | 2026-05-05 |
