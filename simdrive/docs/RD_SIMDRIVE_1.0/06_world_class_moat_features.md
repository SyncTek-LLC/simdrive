...
Score: B2 (S/4/4) + B3 (M/4/4). Both depend on the 1.0 `perf` tool Example Reader validated (`00a_VALIDATED_FACTS.md` §A row 8) and on F1 for storage.
...
**Hard to replicate:** the data is easy; the *taste* of which thresholds fail PRs without flake is months of dogfood. Example Reader iOS is the corpus we need; competitors don't have it.
...
|---|---|---|
| 2026 Q3 (1.0) | Launch. Example Reader + 4–6 design partners. ~$5K MRR. | Trademark filed; trial funnel measured. |
