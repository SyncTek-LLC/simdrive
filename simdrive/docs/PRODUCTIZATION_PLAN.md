...
Palace is already migrated. No paying customers on `specterqa-ios`. **Use PEP 440 deprecation + replacement-redirect, not yank** — yanking breaks reproducible historical builds.
