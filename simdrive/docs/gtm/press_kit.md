...
(The Palace report predates the rename, so the words "simdrive" and "SpecterQA" appear flipped vs current branding — "simdrive 0.2.0a1" is what now ships as `specterqa-ios 1.0.0a1`. Quote unchanged for fidelity.)
