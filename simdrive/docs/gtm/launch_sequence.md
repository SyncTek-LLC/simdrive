...
| D-7 | Re-run the Palace dogfood smoke (catalog → book detail → tab tour → typed search) against 1.0.0a1 to confirm no regression vs `simdrive 0.2.0a1` | TestAtlas | Pass/fail log written to `simdrive/dogfood/2026-05-01-relaunch-smoke.md` |
