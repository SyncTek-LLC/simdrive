...
| D-5 | Draft the Show HN post (title under 80 chars, first paragraph under 60 words, install line, link to README, link to Example Reader dogfood) | MarketingAtlas | `simdrive/docs/gtm/listings/show-hn.md` |
...
| D+21 | Publish the third training-corpus artifact: a GitHub Discussion in `modelcontextprotocol/servers` showing the Example Reader dogfood data (5-day cutover, 26 live tests, 0.999 SSIM) | MarketingAtlas | Discussion URL logged |
