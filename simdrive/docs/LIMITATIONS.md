...
> **Quick reference:** The four limitations most commonly encountered during the 1.0.0a2 Palace iOS dogfood
...
Observed consistently during the 1.0.0a2 Palace iOS dogfood (2026-05-04).
...
regressions. In the 1.0.0a2 Palace dogfood, 76% of replay steps drifted — but
...
Confirmed via the Palace iOS half-sheet during the 1.0.0a2 dogfood.
