...
Example Reader landed a complementary primitive layer in https://github.com/exampleorg/ios-core/pull/937 — `.Example Reader-state/operations/reset-fresh-install.sh` + snapshot/restore. With Layer 2 (this proposal) shipped:
