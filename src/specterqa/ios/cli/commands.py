...
def run(
    ...
    \b
    Example:
      specterqa ios run --product palace-ios --journey smoke-test
      specterqa ios run --product palace-ios --journey smoke-test --device <UDID>
      specterqa ios run --product palace-ios --journey smoke-test --app ./build/Palace.app
      specterqa ios run --product palace-ios --journey smoke-test --backend xctest
    """
    if verbose:
...
def ios_init(app_slug: str, display_name: str, target_dir: str, force: bool) -> None:
    ...
    \b
    Example:
      specterqa ios init --slug palace-ios --name "Palace"
    """
...
def smoke(ctx: click.Context, product: str, device_id: str | None, budget: float) -> None:
    ...
    \b
    Example:
      specterqa ios smoke --product palace-ios
    """
...
def validate(product: str, journey: str | None) -> None:
    ...
    \b
    Example:
      specterqa-ios validate --product palace-ios
      specterqa-ios validate --product palace-ios --journey smoke-test
    """
    errors: list[str] = []
    warnings: list[str] = []
    checks: list[tuple[str, bool, str]] = []
