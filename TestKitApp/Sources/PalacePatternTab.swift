...
/// Reproduces the exact Palace patterns that crash XCTest:
...
struct PalacePatternTab: View {
    ...
    // Simulates Palace's download progress publisher
            ...
            List {
                Section("Book State Machine") {
                    Text("State: \(bookState)")
                        .accessibilityIdentifier("palace_book_state")

                    Button("Borrow") {
                        simulateBorrow()
                    }
                    .accessibilityIdentifier("palace_btn_borrow")

                    Button("Download") {
                        simulateDownload()
                    }
                    .accessibilityIdentifier("palace_btn_download")

                    Button("Return") {
                        simulateReturn()
                    }
                    .accessibilityIdentifier("palace_btn_return")

                    if downloadProgress > 0 && downloadProgress < 1 {
                        ProgressView(value: downloadProgress)
                            .accessibilityIdentifier("palace_download_progress")
                    }
                }
                ...
                Section("Library Switch") {
                    ...
                    .accessibilityIdentifier("palace_btn_switch_library")
                }

                Section("Notification Flood") {
                    Text("Notifications fired: \(notificationCount)")
                        .accessibilityIdentifier("palace_notification_count")

                    Button("Fire 10 Notifications") {
                        fireNotificationCascade(count: 10)
                    }
                    .accessibilityIdentifier("palace_btn_fire_notifications")
                }

                Section("Status") {
                    Text(statusLog)
                        .accessibilityIdentifier("palace_status_log")
                }
            }
            .navigationTitle("Palace Patterns")
    ...
    // MARK: - Palace State Machine Simulation
...
class LibrarySwitchTableViewController: UITableViewController {
    var onSelect: ((String) -> Void)?
    let libraries = ["A1QA Test Library", "New York Public Library", "Brooklyn Public Library",
    ...
    override func viewDidLoad() {
        ...
        view.accessibilityIdentifier = "palace_library_list"
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.accessibilityIdentifier = "palace_library_\(indexPath.row)"
        return cell
    }
