...
consumer cohort outside Example Reader + BusinessAtlas dogfood that depends on the
...
from real Example Reader usage.
...
1. Live verification matrix:
   ...
   Run the full Example Reader auth journey against each. Zero crashes required.
...
6. Maurice / Example Reader re-runs Test Library on v16.0.0 — confirms the AX-crash class is
