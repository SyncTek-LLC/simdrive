...
class TestExample ReaderNotificationCascade:
    ...
    def test_borrow_flow_survives(self):
        ...
        _ensure_tab("Example Reader", "Example Reader_btn_borrow")
        ...
        el = _find(identifier="Example Reader_book_state")
        assert el is not None, "Example Reader_book_state not found"
    ...
    def test_return_flow_survives(self):
        ...
        _ensure_tab("Example Reader", "Example Reader_btn_return")
    ...
    def test_notification_flood_10_rapid_survives(self):
        ...
        _ensure_tab("Example Reader", "Example Reader_btn_fire_notifications")

        _tap(identifier="Example Reader_btn_fire_notifications")
        time.sleep(1.0)

        _assert_runner_alive("10-notification flood")

        el = _find(identifier="Example Reader_notification_count")
        assert el is not None
        val = str(el.get("label", "") or el.get("value", ""))
    ...
    def test_library_switch_modal_survives(self):
        ...
        _ensure_tab("Example Reader", "Example Reader_btn_switch_library")

        _tap(identifier="Example Reader_btn_switch_library")
        time.sleep(1.5)
        ...
        _tap(identifier="Example Reader_library_0")
        time.sleep(2.0)
