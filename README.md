...
Then in Claude Code: _"Run a smoke test on the Example Reader app, record it as example-smoke"_. Claude drives the simulator, records every action. After that, CI runs it free — no AI involved.
